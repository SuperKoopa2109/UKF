...
class UnscentedKalmanFilter(object):
    ...
    def predict(self, dt=None, UT=None, fx=None, tst=None, chi_prev_tmp=None, mu_prev_tmp=None, sigma_prev_tmp=None, S_pred_tmp=None, **fx_args):
        r"""
    ...
    def update(self, z, R=None, UT=None, hx=None, tst=None, **hx_args):
        """
        ...
        **hx_args : keyword argument
        ...
        zp, self.S = UT(self.sigmas_h, self.Wm, self.Wc, R, self.z_mean, self.residual_z, tst=tst)
